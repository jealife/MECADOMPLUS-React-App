...
export default function About() {
    return (
        <section class="bg-white dark:bg-gray-900 py-8">
            <div class="grid max-w-screen px-4  mx-auto   py-16 grid-cols-2 md:grid-cols-1">
                ...
                <div class="md:mt-5 flex">
                    <img className=' rounded-2xl md:w-full object-cover' src="https://www.planeteautomobile.com/wp-content/uploads/2022/03/recharger-une-batterie-de-voiture-thermique.jpg" alt="mockup" />
                </div>
            </div>
        </section>
